...
- **[Mötesroller](spec/roles/meeting-roles.md)** — *ladda när:* arbete med mötesordförande, mötessekreterare, protokolljusterare eller rösträknare — deras ephemerala tilldelning per stämma, signering, och separation från stående roller.
